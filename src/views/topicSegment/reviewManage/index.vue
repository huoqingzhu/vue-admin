      ...
      <div class="box-card">
        ...
        <div class="option-card">
          ...
          <div class="center">
            建设单位：
            <el-select
              v-model="searchParameters.resType"
              placeholder="请选择"
              size="small"
              style="width: 100%"
            >
          ...
          <div class="center">
            申报单位：
            <el-select
              v-model="searchParameters.state"
              placeholder="请选择"
              size="small"
              style="width: 100%"
            >
      ...
      <div class="box-card" style="margin-top: 20px">
        ...
        <div>
          ...
          >
            ...
            <el-table-column label="评审会名称" prop="resName" sortable>
            </el-table-column>
            <el-table-column label="评审项目" prop="build" sortable>
            </el-table-column>
            <el-table-column label="评审时间" prop="declare" sortable>
            </el-table-column>
            <el-table-column label="评审专家" prop="time" sortable>
            </el-table-column>
      ...
      return new Promise((resolve) => {
        ...
        for (let i = 0; i < 9; i++) {
          const obj = {
            resName: `项目${i}`,
            build: "项目1，项目2",
            declare: "2021-08-10 09：00- 18：00",
            time: "专家1,专家2",
            resType: i,
          };
          list.push(obj);
